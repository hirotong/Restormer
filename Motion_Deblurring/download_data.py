...
for data in args.data.split("-"):
    if data == "train":
        ...
        os.system(f"gdrive files download {GoPro_train} --destination Datasets/Downloads/")
    ...
    if data == "test":
        if dataset == "all" or dataset == "GoPro":
            ...
            os.system(f"gdrive files download {GoPro_test} --destination Datasets/")
            print("Extracting GoPro Data...")
        ...
        if dataset == "all" or dataset == "HIDE":
            ...
            os.system(f"gdrive files download {HIDE_test} --destination Datasets/")
        ...
        if dataset == "all" or dataset == "RealBlur_R":
            ...
            os.system(f"gdrive files download {RealBlurR_test} --destination Datasets/")
        ...
        if dataset == "all" or dataset == "RealBlur_J":
            ...
            os.system(f"gdrive download {RealBlurJ_test} --destination Datasets/")
